...
((("litecoin", "benefits of", id="BCbasicbenefits0")))((("decentralized systems", "litecoin as")))Mastering Litecoin was forked, revised, and updated from Mastering Bitcoin.  Our motivation in doing so was to provide a technical overview of litecoin as an entry point for budding developers.  Andreas M. Antonopoulos, the original author of Mastering Bitcoin, describes his motivation for writing the very first comprehensive book on bitcoin below.
